...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        player_walk_1 = pygame.image.load('graphics/Player/p1_walk/PNG/p1_walk01.png').convert_alpha()
        player_walk_2 = pygame.image.load('graphics/Player/p1_walk/PNG/p1_walk02.png').convert_alpha()
        player_walk_3 = pygame.image.load('graphics/Player/p1_walk/PNG/p1_walk03.png').convert_alpha()
...
game_name = test_font.render('Blorp Runder', False, (111, 196, 169))
